...
class SelfUpdateCommandSpec extends ObjectBehavior
{
    function let(InputInterface $input, UpdaterInterface $updater)
    {
        ...
        $input->getOption('stability')->willReturn(UpdaterInterface::STABILITY_ANY);
    ...
    function it_checks_if_update_is_needed(UpdaterInterface $updater, InputInterface $input, OutputInterface $output)
    {
    ...
    function it_updates_application_to_new_version(UpdaterInterface $updater, InputInterface $input, OutputInterface $output)
    {
